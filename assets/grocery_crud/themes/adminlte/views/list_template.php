                ...
                <thead>
                    ...
                    <tr class="filter-row gc-search-row">
                        ...
                        <td class="no-border-left <?php if ($buttons_counter === 0) {?>hidden<?php }?>">
                            ...
                            <?php endif ?>
                            <?php if (isset($set_print_custom) AND $set_print_custom): ?>
                            <div class="floatL">
                                <a data-url="<?php echo isset($url_print_custom) ? $url_print_custom : '' ?>" href="javascript:void(0);" title="<?php echo $this->l('list_print')?>"
                                   class="hidden btn btn-default print-selected-button">
                                    <i class="fa fa-print text-info"></i>
                                    <span class="text-success">Cetak</span>
                                </a>
                            </div>
                            <?php endif ?>
                            <div class="floatR l5">
