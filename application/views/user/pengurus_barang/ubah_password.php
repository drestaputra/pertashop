                    ...
                    <div class="panel-footer">
                        <div class="row">
                            <div class="col-md-9 col-md-offset-3">
                                ...
                                <a href="<?php echo base_url('pengurus_barang'); ?>" class="btn btn-default">Cancel</a>
                            </div>
                        </div>
                    </div>
                </form>                                     
...
$('form#change_password').submit(function(event) {
    ...
    if (confirm("Yakin mengubah password?")) {
      $.ajax({
        url: '<?php echo base_url().'pengurus_barang/change_password/'.$id_pengurus_barang ?>',
        type: 'POST',
        dataType: 'JSON',
        data: formData,
        success :function (response){
          if (response.status == 200) {
            window.location = '<?php echo base_url("pengurus_barang?status=200&msg=").base64_encode("Berhasil mengubah pengurus_barang"); ?>';
          }else{
