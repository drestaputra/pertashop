...
<html class="fixed">
	<head>
		...
		<!-- Basic -->
		<meta charset="UTF-8">
		<title>Owner | <?php echo function_lib::get_config_value('website_name'); ?></title>
		...
		<script type="text/javascript">
                    ...
                    $("#gridview").flexigrid({
                        ...
                        colModel: [
                            ...
                            { display: 'Email', name: 'email', width: 100, sortable: true, align: 'center' },
                            { display: 'Status', name: 'status', width: 100, sortable: true, align: 'center' },                            
                            { display: 'Nama Owner', name: 'nama_owner', width: 100, sortable: true, align: 'center' },                            
                            { display: 'Nama Koperasi', name: 'nama_koperasi', width: 100, sortable: true, align: 'center' },                            
                            { display: 'No. HP', name: 'no_hp', width: 100, sortable: true, align: 'center' },                            
                            { display: 'Alamat', name: 'alamat', width: 100, sortable: true, align: 'center' },                            
                            { display: 'Kecamatan', name: 'kecamatan', width: 100, sortable: true, align: 'center' },                            
                            { display: 'Kabupaten', name: 'kabupaten', width: 100, sortable: true, align: 'center' },                            
                            { display: 'Provinsi', name: 'provinsi', width: 100, sortable: true, align: 'center' },                            
                            { display: 'No. Badan Hukum', name: 'no_badan_hukum', width: 100, sortable: true, align: 'center' },                            
                            { display: 'Biaya Administrasi', name: 'biaya_administrasi', width: 100, sortable: true, align: 'center' },                            
                            { display: 'Biaya Tabungan', name: 'biaya_simpanan', width: 100, sortable: true, align: 'center' },                            
                            { display: 'Bunga Pinjaman', name: 'bunga_pinjaman', width: 100, sortable: true, align: 'center' },                            
                            { display: 'Biaya Sewa Aplikasi', name: 'biaya_sewa_aplikasi', width: 100, sortable: true, align: 'center' },                            
                            { display: 'Hari Kerja', name: 'hari_kerja', width: 100, sortable: true, align: 'center' },                            
                        ],
                        buttons: [
                    ...
                    function tambah(){
                    	window.location='<?php echo base_url('user/owner/tambah'); ?>';
                    }
                    ...
                    function grid_reload() {
                        ...
                        "&status="+status+
                        "&email="+email;              
                        $("#gridview").flexOptions({url:'<?php echo base_url(); ?>user/owner/getData'+url_service}).flexReload();
                    }
                    ...
                    function delete_owner(id)
                    {
                        ...
                        {
                             var jqxhr=$.ajax({
                            url:'<?php echo base_url()?>user/owner/delete/'+id,
                            type:'get',
                            dataType:'json',
