            ...
            <div class="row m-b-10">
              <div class="col-md-6">
                 <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="username" value="<?php echo isset($temp['username']) ? $temp['username'] : ''; ?>" class="form-control" placeholder="Username .." required/>
                    </div>                                            
                </div>   
              </div>
              <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        ...
                        <input type="text" name="email" value="<?php echo isset($temp['email']) ? $temp['email'] : ''; ?>" class="form-control" placeholder="Email .." required/>
              ...
              <div class="col-md-6">
                   <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        ...
                        <input type="text" name="no_hp" value="<?php echo isset($temp['no_hp']) ? $temp['no_hp'] : '';  ?>" class="form-control" placeholder="08XXXX" required/>
            ...
            <div class="row m-b-10">
              <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input type="password" class="form-control" name="password" value="<?php echo isset($temp['password']) ? $temp['password'] : '';  ?>">
                    </div>
                </div>
              </div>
              <div class="col-md-6">
                  <div class="form-group">
                      ...
                      <div class="col-md-8">
                          <input type="password" class="form-control" name="conf_password" value="<?php echo isset($temp['password']) ? $temp['password'] : '';  ?>">
                      </div>
                </div>   
              </div>
            </div>
             <div class="row m-b-10">
              <div class="col-md-6">
                <div class="form-group">
                    <label class="col-md-4 control-label" >Tgl Jatuh Pembayaran Sistem</label>
                    <div class="col-md-8">
                        <input type="datetime-local" class="form-control" name="tgl_jatuh_tempo_pembayaran_sistem">
                    </div>
                </div>
              </div>             
            </div>
