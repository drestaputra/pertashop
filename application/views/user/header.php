					...
					<div id="userbox" class="userbox">
						<a href="#" data-toggle="dropdown">
							...
							<div class="profile-info" data-lock-name="" data-lock-email="">
								<span class="name"><?php echo $this->session->userdata('user')['username']; ?></span>
						...
						<div class="dropdown-menu">
							<ul class="list-unstyled">
								...
								<li class="divider"></li>
								<li>
									<a role="menuitem" tabindex="-1" href="<?php echo base_url('user/profil'); ?>"><i class="fa fa-user"></i> Profil</a>
								</li>
								<li class="divider"></li>
