...
<html class="fixed">
	<head>
		...
		<!-- Basic -->
		<meta charset="UTF-8">
		<title>Saran Pemanfaatan | <?php echo function_lib::get_config_value('website_name'); ?></title>
				...
				<section role="main" class="content-body">
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Saran Pemanfaatan</span></li>
							</ol>
					...
					<div class="panel panel-default">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">Saran Pemanfaatan</h3>
                        </div>
