...
<html class="fixed">
	<head>
		...
		<!-- Basic -->
		<meta charset="UTF-8">
		<title><?php echo isset($subject) ? $subject : "" ?> | <?php echo function_lib::get_config_value('website_name'); ?></title>
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					<header class="page-header">
						<h2><?php echo isset($subject) ? $subject : "" ?></h2>
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span><?php echo isset($subject) ? $subject : "" ?></span></li>
							</ol>
					...
					<div class="panel panel-default">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title"><?php echo isset($subject) ? $subject : "" ?></h3>
                        </div>
