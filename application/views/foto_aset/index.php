...
<html class="fixed">
	<head>
		...
		<!-- Basic -->
		<meta charset="UTF-8">
		<title>Foto Aset <?php echo isset($nama_aset) ? $nama_aset : "";  ?> | <?php echo function_lib::get_config_value('website_name'); ?></title>
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					<header class="page-header">
						<h2>Foto Aset <?php echo isset($nama_aset) ? $nama_aset : "";  ?></h2>
					...
					<div class="panel panel-default">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">Foto Aset</h3>
                        </div>
