					...
					<div id="userbox" class="userbox">
						...
						<div class="dropdown-menu">
							<ul class="list-unstyled">
								...
								<li class="divider"></li>
								<li>
									<a role="menuitem" tabindex="-1" href="<?php echo base_url('user/koordinator/profil'); ?>"><i class="fa fa-user"></i> Profil</a>
								</li>
								<li class="divider"></li>
								
								<li>
									<a role="menuitem" tabindex="-1" href="<?php echo base_url('koordinator/logout'); ?>"><i class="fa fa-power-off"></i> Logout</a>
								</li>
