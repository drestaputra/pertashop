...
class grocery_CRUD_Layout extends grocery_CRUD_Model_Driver
{
	...
	protected function showList($ajax = false, $state_info = null)
	{
		...
		$data->set_print_custom		= $this->set_print_custom;
		$data->url_print_custom    	= $this->url_print_custom;
...
class Grocery_CRUD extends grocery_CRUD_States
{
	...
	protected $set_print_custom	= false;
	protected $url_print_custom= '';
	...
	public function set_print_custom()
	{
		$this->set_print_custom = true;

		return $this;
	}
	public function set_url_print_custom($url = "")
	{
		$this->url_print_custom = $url;
